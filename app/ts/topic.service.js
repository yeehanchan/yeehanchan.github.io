System.register(['angular2/core', 'angular2/http', './topic', 'rxjs/Observable', './environment'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, topic_1, Observable_1, http_2, environment_1;
    var TopicService;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            TopicService = (function () {
                function TopicService(http) {
                    this.http = http;
                    this._searchTopicUrl = environment_1.Env._baseUrl + 'search/';
                    this._addTopicUrl = environment_1.Env._baseUrl + 'topics/';
                    this._getTopicUrl = environment_1.Env._baseUrl + 'getTopic/';
                }
